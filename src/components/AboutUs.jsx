      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="flex justify-center">
          <img
            ...
            className="rounded-2xl shadow-lg object-cover w-full md:w-[90%] h-[350px] md:h-[450px]"
          />
        </div>
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <p>
            Through its education investments, Fanrong Holdings is committed to
            transforming learning environments, bridging skill gaps, and
